...
const ReviewSection = () => {
  ...
  return (
    <section className="py-16 px-4 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-blue-950/30 dark:via-indigo-950/20 dark:to-purple-950/30 relative overflow-hidden">
      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-5xl mx-auto mb-16">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 p-4 bg-white/70 dark:bg-legal-slate/20 backdrop-blur-sm rounded-lg border border-indigo-100/60 dark:border-legal-slate/30 shadow-sm">
            <div className="flex items-center gap-3">
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="outline" size="sm" className="flex items-center gap-2 bg-white dark:bg-legal-slate/40 border-indigo-100 dark:border-legal-slate/40">
                ...
                <DropdownMenuContent align="start" className="bg-white/95 dark:bg-legal-slate/95 backdrop-blur-sm border-indigo-100 dark:border-legal-slate/40">
            ...
            <AnimatePresence mode="wait">
              {filteredReviews.length > 0 ? (
                filteredReviews.map((review) => (
                  ...
                  >
                    <Card className="h-full border-indigo-100/60 dark:border-legal-slate/30 bg-white/80 dark:bg-legal-slate/20 backdrop-blur-sm shadow-md hover:shadow-lg transition-all duration-300">
                      <CardHeader className="pb-2">
                        <div className="flex justify-between items-start">
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-legal-accent to-indigo-600 flex items-center justify-center text-white">
                ...
                <motion.div 
                  className="col-span-2 text-center py-10 bg-white/50 dark:bg-legal-slate/10 rounded-xl border border-indigo-100/40 dark:border-legal-slate/30 shadow-sm"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                >
                  ...
                  <Button 
                    ...
                    className="mt-4 bg-white dark:bg-legal-slate/40 border-indigo-100 dark:border-legal-slate/40"
                  >
                    Clear Filters
                  </Button>
                </motion.div>
