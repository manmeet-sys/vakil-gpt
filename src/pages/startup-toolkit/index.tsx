    ...
    >
      <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
        <div className="md:col-span-1">
          ...
          <Card className="mt-6">
            <CardHeader>
              <CardTitle className="text-xl">Why Use Our Indian Legal Templates</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-start">
                <CheckCircle className="h-5 w-5 text-legal-accent mr-2 mt-0.5 flex-shrink-0" />
                <p className="text-sm text-legal-muted">Templates customized for Indian legal framework and regulations</p>
              </div>
              <div className="flex items-start">
                <CheckCircle className="h-5 w-5 text-legal-accent mr-2 mt-0.5 flex-shrink-0" />
                <p className="text-sm text-legal-muted">Regularly updated to reflect the latest Indian laws and amendments</p>
              </div>
              <div className="flex items-start">
                <CheckCircle className="h-5 w-5 text-legal-accent mr-2 mt-0.5 flex-shrink-0" />
                <p className="text-sm text-legal-muted">Save on expensive legal fees while ensuring compliance</p>
              </div>
              <div className="flex items-start">
                <CheckCircle className="h-5 w-5 text-legal-accent mr-2 mt-0.5 flex-shrink-0" />
                <p className="text-sm text-legal-muted">Vetted by experienced Indian corporate lawyers</p>
              </div>
              <div className="flex items-start">
                <IndianRupee className="h-5 w-5 text-legal-accent mr-2 mt-0.5 flex-shrink-0" />
                <p className="text-sm text-legal-muted">Specific attention to Indian tax implications and GST requirements</p>
              </div>
              <div className="flex items-start">
                <Landmark className="h-5 w-5 text-legal-accent mr-2 mt-0.5 flex-shrink-0" />
                <p className="text-sm text-legal-muted">Compliance with Indian regulatory bodies like MCA, SEBI, and RBI</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="md:col-span-2">
          <Card className="h-full">
            <CardHeader>
              ...
              <CardDescription>Select a document to preview, edit, and download</CardDescription>
            </CardHeader>
            <CardContent>
              {selectedDocument ? (
                <div className="space-y-6">
                  ...
                  {editingDocument ? (
                    ...
                    <div>
                      ...
                      <p className="text-legal-muted mb-2">{selectedDocument.description}</p>
                      ...
                      {selectedDocument.indianContext && (
                        <div className="bg-amber-50 dark:bg-amber-900/20 p-3 rounded-md border border-amber-200 dark:border-amber-800 mb-4">
                          <p className="text-sm text-amber-800 dark:text-amber-300 font-medium">Indian Legal Context</p>
                          <p className="text-sm text-amber-700 dark:text-amber-400">{selectedDocument.indianContext}</p>
                        </div>
                      )}
                      
                      <div className="bg-legal-accent/5 p-6 rounded-md border border-legal-accent/20 mb-6 font-mono text-sm whitespace-pre-wrap overflow-auto max-h-[500px]">
                        {selectedDocument.content || selectedDocument.preview}
                      </div>
                    </div>
                  )}
                </div>
                    ...
                    >
                      ...
                      <CardContent>
                        ...
                        {document.indianContext && (
                          <Badge variant="outline" className="mt-2 text-xs bg-amber-50 text-amber-800 border-amber-200 dark:bg-amber-900/20 dark:text-amber-300 dark:border-amber-800">
                            Indian Compliant
                          </Badge>
                        )}
                      </CardContent>
                      <CardFooter className="flex justify-between">
                        <Button variant="ghost" className="text-legal-accent">
      ...
      <Dialog open={false}>
        <DialogContent>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="dialog-document-title">Document Title</Label>
              <Input id="dialog-document-title" placeholder="Enter document title" />
            </div>
            
            <div className="space-y-2">
              <Label htmlFor="dialog-document-content">Document Content</Label>
              <Textarea 
                id="dialog-document-content" 
                placeholder="Enter document content" 
