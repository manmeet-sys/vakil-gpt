...
/**
 * Calculator utility functions for legal calculations
 */
...
export const calculateInterest = (
  ...
  switch (interestType) {
    case "simple":
      return (principalAmount * rate * days) / (100 * 365);
    case "compound":
      // Daily compound interest
      return principalAmount * Math.pow(1 + rate / (100 * 365), days) - principalAmount;
    default:
      return (principalAmount * rate * days) / (100 * 365);
  }
};
